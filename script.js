...
const gifs = [
    "https://media.tenor.com/9vB_77p8_mEAAAAi/cute-cat.gif",
    "https://media.tenor.com/A6p_YId0H7wAAAAi/090620.gif",
    "https://media.tenor.com/X_S9D8Y7IqAAAAAi/peach-goma.gif",
    "https://media.tenor.com/mUvK6m_S6fMAAAAi/peach-goma.gif"
];
...
function handleNo() {
    ...
    if (clickCount > 2 && clickCount < 5) gif.src = gifs[1];
    if (clickCount >= 5 && clickCount < 8) gif.src = gifs[2];
    if (clickCount >= 8) gif.src = gifs[3];
